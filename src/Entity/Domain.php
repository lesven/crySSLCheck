...
class Domain
{
    ...
    #[ORM\Column(length: 20, enumType: DomainStatus::class, options: ['default' => 'active'])]
    ...
    {
        $this->status = $this->status === DomainStatus::ACTIVE ? DomainStatus::INACTIVE : DomainStatus::ACTIVE;
    }
